...
def main():
    """
        Usage: python3 roberta.py --data PATH --dataset {philippines}{us-election}{ukraine-war} --model MODEL
    """
    ...
    # model_name = args.model if args.model else (PHILIPPINES_MODEL if args.dataset == "philippines" else US_ELECTION_MODEL)
