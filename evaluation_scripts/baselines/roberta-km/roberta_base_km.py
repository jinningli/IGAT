...
PHILIPPINES_MODEL = "Dir/roberta-base-ep30-philippines-ft-10"
US_ELECTION_MODEL = "Dir/roberta-base-us-election-ft-10"
UKRAINE_WAR_MODEL = "Dir/roberta-base-ukraine-war-ft-10"

# Load RoBERTa in eval mode
# tokenizer = RobertaTokenizer.from_pretrained("Dir/roberta-base-ep30-philippines-ft-10")
# model = RobertaModel.from_pretrained("Dir/roberta-base-ep30-philippines-ft-10")
# model.eval()
tokenizer = None
model = None
...
def main():
    ...
    parser.add_argument("--dataset", required=True, type=str, 
                    help="If dataset=philippines => multi-class approach using majority vote, else => 4-class using brute force.")
    args = parser.parse_args()

    # 1) Load the domain-specific model
