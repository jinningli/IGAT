...
US_ELECTION_MODEL = "Dir/twitter-roberta-us-election-ft-10"
PHILIPPINES_MODEL = "Dir/twitter-roberta-philippines-ft-10"
UKRAINE_WAR_MODEL = "Dir/twitter-roberta-ukraine-war-ft-10"
...
def main():
    """
        Usage: python3 roberta_base_finetune.py --data PATH --dataset philippines/us-election
    """
